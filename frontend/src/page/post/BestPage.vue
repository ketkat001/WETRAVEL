<template>
  <div id="main" class="main">
    ...
    <div class="best-content container">
      <h3>{{ $route.params.city }} BEST 5</h3>
...
<script>
const best_card = {title: '서울의 밤은 밝다', author: '서울 야경', image: 'https://placeimg.com/640/480/nature'}
const cards = [
